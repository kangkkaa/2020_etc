...
if($mode=="modify"){
	$sqlP = "SELECT * FROM popupAdmin WHERE idx='".$pidx."'";
	$rsp = mysql_fetch_array(mysql_query($sqlP));
	$b_contents_input = htmlspecialchars($rsp['po_contents']);
}
?>
<!DOCTYPE html>
<html>
	...
	<div class="content-wrapper">
			<div class="container">
				...
				<div class="panel panel-inverse">
						<div class="panel-heading"><i class="fa fa-cog"></i>&nbsp;&nbsp;팝업관리 설정</div>
						<div class="panel-body">
							<form name="tx_editor_form" id="tx_editor_form" method="post" accept-charset="utf-8">
							<div class="form-group">
								<label class="col-one-fifth control-label nobottommargin"><i class="fa fa-check-square text-default"></i>&nbsp;&nbsp;팝업제목</label>
								<div class="col-four-fifth col-last nobottommargin">
									<input type="text" name="po_subject" value="<?=$rsp['po_subject']?>" class="form-control" >
								</div>
							</div>
							<div class="n_divider"></div>
							<div class="form-group">
								<label class="col-one-fifth control-label nobottommargin"><i class="fa fa-check-square text-default"></i>&nbsp;&nbsp;시간</label>
								<div class="col-four-fifth col-last nobottommargin">
									<input type="text" name="po_time"  value="<?=$rsp['po_time']?>" class="form-control" style="width:10% !important; display:inline-block;">&nbsp;시간
									<p><strong>고객이 다시 보지 않음을 선택할 시 몇 시간동안 팝업레이어를 보여주지 않을지 설정합니다.</strong></p>
								</div>
							</div>
							<div class="n_divider" style="clear:both;"></div>
							<div class="form-group">
								<label class="col-one-fifth control-label nobottommargin"><i class="fa fa-check-square text-default"></i>&nbsp;&nbsp;시작일</label>
								<div class="col-four-fifth col-last nobottommargin">
									<input type="text" name="po_starttime"  value="<?=$rsp['po_starttime']?>"  class="form-control" style="width:20% !important; display:inline-block;">
									&nbsp;<input type="checkbox" value="<?=date("Y-m-d 00:00:00",time());?>" name="start_check" style="display:inline-block;" onclick="if (this.checked == true) this.form.po_starttime.value=this.form.start_check.value; else this.form.po_starttime.value = this.form.po_starttime.defaultValue;">
									<strong>시작일시를 오늘로</strong>
								</div>
							</div>
							<div class="form-group">
								<label class="col-one-fifth control-label nobottommargin"><i class="fa fa-check-square text-default"></i>&nbsp;&nbsp;종료일</label>
								<div class="col-four-fifth col-last nobottommargin">
									<input type="text" name="po_endtime"  value="<?=$rsp['po_endtime']?>" class="form-control" style="width:20% !important; display:inline-block;">
									&nbsp;<input type="checkbox" value="<?=date("Y-m-d 23:59:59",time()+(60*60*24*7));?>" name="end_check" style="display:inline-block;" onclick="if (this.checked == true) this.form.po_endtime.value=this.form.end_check.value; else this.form.po_endtime.value = this.form.po_endtime.defaultValue;">
									<strong>종료일시를 오늘로부터 7일 후로</strong>
								</div>
							</div>
							<div class="n_divider" style="clear:both;"></div>
							<div class="form-group">
								<label class="col-one-fifth control-label nobottommargin"><i class="fa fa-check-square text-default"></i>&nbsp;&nbsp;팝업레이어 위치</label>
								<div class="col-four-fifth col-last nobottommargin">
									좌측&nbsp;<input type="text" name="po_left" value="<?=$rsp['po_left']?>" class="form-control" style="width:20% !important; display:inline-block;">px&nbsp;&nbsp;&nbsp;&nbsp;
									상단&nbsp;<input type="text" name="po_top" value="<?=$rsp['po_top']?>" class="form-control" style="width:20% !important; display:inline-block;">px
								</div>
							</div>
							<div class="form-group" style="clear:both;">
								<label class="col-one-fifth control-label nobottommargin"><i class="fa fa-check-square text-default"></i>&nbsp;&nbsp;팝업레이어 크기</label>
								<div class="col-four-fifth col-last nobottommargin">
									넓이&nbsp;<input type="text" name="po_width" value="<?=$rsp['po_width']?>" class="form-control" style="width:20% !important; display:inline-block;">px&nbsp;&nbsp;&nbsp;&nbsp;
									높이&nbsp;<input type="text" name="po_height" value="<?=$rsp['po_height']?>" class="form-control" style="width:20% !important; display:inline-block;">px
								</div>
							</div>
							<div class="n_divider" style="clear:both;"></div>
							<div class="form-group">
								<label class="col-one-fifth control-label nobottommargin"><i class="fa fa-check-square text-default"></i>&nbsp;&nbsp;팝업링크</label>
								<div class="col-four-fifth col-last nobottommargin">
									<input type="text" name="po_link" value="<?=$rsp['po_link']?>" class="form-control" >
								</div>
							</div>
							<div class="n_divider" style="clear:both;"></div>
							<div class="form-group">
								<label class="col-one-fifth control-label nobottommargin"><i class="fa fa-check-square text-default"></i>&nbsp;&nbsp;링크타켓</label>
								<div class="col-four-fifth col-last nobottommargin">
									<select name="po_target" class="form-control">
										<option value="_blank" <?if($rsp['po_target']=="_blank"){echo "selected";}?>>새창에서 연결</option>
										<option value="_self"<?if($rsp['po_target']=="_self"){echo "selected";}?>>현재창에서 연결</option>
									</select>
								</div>
							</div>
							<div class="n_divider" style="clear:both;"></div>
							<div class="form-group">
								<label class="col-one-fifth control-label nobottommargin"><i class="fa fa-check-square text-default"></i>&nbsp;&nbsp;내용</label>
								<div class="col-four-fifth col-last nobottommargin">
<!-- 다음 에디터 시작-->
...
<!-- 다음 에디터 끝 -->
							...
							<a href="popupAdmin.php"><span class="button button-light btn-sm"><i class="fa fa-times left-icon"></i>취소</span></a>
							<button type="button" class="button button-default btn-sm" onclick="saveContent();"><i class="fa fa-check left-icon"></i>확인</button>
							</div>
						</div>
						</form>
						</div>
...
function validForm(editor) {
	...
	if (form.po_subject.value == "") {
		alert('제목을 입력하세요.');
		form.po_subject.focus();
		return false;
