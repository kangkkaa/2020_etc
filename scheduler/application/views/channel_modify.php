    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <i class="fa fa-table"></i> CHANNEL MODIFY</div>
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                        <?php echo form_open('/channel/modify_ok/'); ?>
                        ...
                        <div class="form-group input-group">
                            ...
                            <input type="text" name="account_info" value="<?php if(!set_value('account_info')) echo $data['account_info']; else echo set_value('account_info'); ?>" id="account_info" class="form-control">
                        </div>
                        <div align="right">
