    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <i class="fa fa-table"></i> SERVER WRITE</div>
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                            <?php echo form_open('/server/write_ok/'); ?>
                            <b><?php echo validation_errors(); ?></b>
                            <div class="form-group input-group">
                                <label>서버이름</label>
                                <input type="text" name="server_name" id="server_name" value="<?php echo set_value('server_name'); ?>" class="form-control" >
                            </div>
                            <div class="form-group input-group">
                                <label>서버아이피</label>
                                <input type="text" name="server_ip" id="server_ip" value="<?php echo set_value('server_ip'); ?>" class="form-control" >
                            </div>
                            <div class="form-group input-group">
                                <label>설명</label>
                                <input type="text" name="server_comment" id="server_comment" value="<?php echo set_value('server_comment'); ?>" class="form-control">
                            </div>
                            <div align="right">
